...
import br.com.home.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link br.com.home.domain.Pessoa}.
 */
@RestController
        ...
        Optional<Pessoa> result = pessoaRepository
            ...
            .map(existingPessoa -> {
                ...
                if (pessoa.getGenero() != null) {
                    existingPessoa.setGenero(pessoa.getGenero());
                }
                if (pessoa.getMiniBio() != null) {
                    existingPessoa.setMiniBio(pessoa.getMiniBio());
                }
